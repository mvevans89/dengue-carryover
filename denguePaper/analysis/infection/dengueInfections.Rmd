...
```{r}
png(file="../figures/forMS/bodyInfxMeanTemp.png", width = 4, height=4, units="in", res=500, family="sans")
ggplot(data=seasonInfSite, aes(x=Temp_mean, y=Body))+
  geom_point(aes(color=class, shape=block), size=4) + 
  scale_color_manual(values=c(colRural, colSuburban, colUrban)) +
  theme_base() +
...
```{r}
png(file="../figures/forMS/bodyInfxMinTemp.png", width = 4, height=4, units="in", res=500, family="sans")
