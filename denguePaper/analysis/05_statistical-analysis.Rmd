...
This document contains the code for the analysis of mosquito population and infection data in 'Carry-over effects of urban larval environments on the transmission potential of dengue virus' (Evans et al. 2018).

Paper Citation:

Evans MV, Shiau JC, Solano N, Brindley MA, Drake JM, Murdock, CC. 2018.  Carry-over effects of urban larval environments on the transmission potential of dengue virus.  *BMC Parasites and Vectors*.
