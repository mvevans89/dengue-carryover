...
```{r}
##------------ Mean T
climModMean <- lmer(meanT~Class*Block+ (1|Day) + (1|Site_ID), data=climTray)
plot(climModMean)
summary(climModMean)
confint(climModMean)
AIC(climModMean)
...
climModMin <- lmer(minT~Class*Block + (1|Day) + (1|Site_ID), data=climTray)
plot(climModMin)
summary(climModMin)
confint(climModMin)
AIC(climModMin)
...
##------------ DTR
climModDTR <- lmer(DTR~Class*Block + (1|Day)+ (1|Site_ID), data=climTray)
plot(climModDTR)
summary(climModDTR)
confint(climModDTR)
...
climModMeanRH <- lmer(meanRH~Block*Class + (1|Day) + (1|Site_ID), data=climTray)
plot(climModMeanRH)
