...
demographicPlot <- ggplot(data = allDemoSite, aes(x = as.factor(Class), y = mean)) +
  ...
  geom_pointrange(aes(fill = Class, shape = Block, group = Block, ymin = mean-se, ymax = mean+se), color = "black", position = position_jitterdodge(dodge.width = 0.75, jitter.width = 0.2), size = 1, stroke = 1, lwd = 0.5) +
