...
#png(file="figures/forMS/infection.png", width = 3, height=6, units="in", res=500, family="sans")
...
Infection Plot to Combine with demographic metrics
...
```{r}
png(file="figures/forMS/survEmergeGrowth.png", width = 3, height=6, units="in", res=500, family="sans")
plot_grid(survPlot, emergePlot, growthPlot,
          labels=c("A", "B", "C"),
          nrow=3,
          align='v')
