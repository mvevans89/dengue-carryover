...
We calculated the per capita population growth rate per following citet{livdahl1984} {Eq. \ref{eq:1}}:
...
We calculated the vectorial capacity ($VC$; Equation \ref{eq:3}) for each site and season using a temperature-dependent mechanistic dengue model defined in \citet{mordecai2017}.
