...
pdf(file="figures/forMS/Fig2.pdf", width = 3, height=6, family="sans")

infPlot <- ggplot(data=infLong[order(infLong$block, decreasing=F),], aes(x=class, group=block))+
  ...
  guides(fill = F, color = F,
         alpha = F) +
         #alpha=guide_legend(override.aes=list(color=axisColor, size=0.3), reverse=T)) +
...
Infection plot to combine in 6 panel figure

```{r}
infLong <- infLong[order(infLong$block, decreasing=F),]
...
```{r}
pdf(file="figures/forMS/Fig1.pdf", width = 3, height=6, family="sans")
...
ggdraw()+
  draw_plot(survPlot, x=0.01, y=0.66, width=0.5, height=0.33)+
  draw_plot(emergePlot, x=0, y=0.33, width=0.5, height=0.33)+
  draw_plot(growthPlot, x=0, y=0, width=0.5, height=0.33)+
  draw_plot(bodyPlot, x=0.475, y=0.66, width=0.5, height=0.33)+
  draw_plot(headPlot, x=0.475, y=0.33, width=0.5, height=0.33)+
  draw_plot(SalivaPlot, x=0.475, y=0, width=0.5, height=0.33)+
...
```{r}
pdf(file="figures/forMS/Fig3.pdf", width = 5, height=4, family="sans")
VCxTempPlot
dev.off()
```
...
```{r, eval=F}
pdf(file="figures/forMS/Fig3.pdf", width = 10, height=7, family="sans")
...
VCclass <- lmer(VCforStats~Class*block+ (1|Site_Code), 
                 data=VCplot)
...
VCclassnoCOE <- lmer(VCforStatsnoCOE~Class*block+ (1|Site_Code), 
                 data=VCplot)
