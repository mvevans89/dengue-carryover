...
This document is for the exploratory analysis of larval survey data from the 2016-2017 Surveys in Athens, GA.  
...
habitats <- read.csv("../../data/larvalSurveys/raw/larvalHabitat.csv", stringsAsFactors = F)
#reformat date
