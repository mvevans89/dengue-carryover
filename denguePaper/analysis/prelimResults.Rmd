...
#pairwise
summary(glht(siteEmerg, linfct = mcp(block = "Tukey"), test = adjusted("holm")))

summary(glht(siteEmerg, linfct = mcp(Class = "Tukey"), test = adjusted("holm")))
...
mixEmerge$block <- as.factor(mixEmerge$block)
